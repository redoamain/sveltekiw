...
function mapRow(r: Record<string, unknown>): ReturRow {
  return {
...
export async function getReturPaged(opts: { q?: string; tgl1?: string; tgl2?: string; page: number; pageSize: number }) {
...
export async function getReturForExport(opts: { q?: string; tgl1?: string; tgl2?: string; ids?: string[] }) {
  if (opts.ids?.length) {
